...
function addMovies(){
    const inputName = document.getElementById('txt-name')
    const inputcategoria = document.getElementById('txt-categoria')
    const inputPhoto = document.getElementById('txt-photo')
    movies.push({
        nome: inputName.value,
...
const loadMovies = () => {
    const divProductList = document.getElementById('movies-list')

    divProductList.innerHTML = null
